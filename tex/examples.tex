...
\begin{table}[H]
  \centering
  \footnotesize
\begin{tabular}[c]{|p{2cm}|p{2.5cm}|p{2cm}|p{3.5cm}|}
  \hline
  Κωδικός\_ Εκδήλωσης & Ύπαρξη\_Θέσεων\_ Καθήμενων & Είδος                       & Opening\_Act            \\ \hline
  8053                & Όχι                        & Hip hop Live                & DJ Πρύτανης warm up set \\ \hline
  8055                & Όχι                        & Έντεχνο τραγούδι - Συναυλία & Μίλτος Πασχαλίδης       \\ \hline
\end{tabular}
\end{table}
...
\begin{table}[H]
  ...
  \hline
  Κωδικός\_Εκδήλωσης & Ύπαρξη\_Θέσεων\_VIP & Άθλημα   \\ \hline
  4444               & Ναι                 & Μπάσκετ  \\ \hline
  1235               & Ναι                 & Τένις    \\ \hline
  6969               & Όχι                 & Beerpong \\ \hline
\end{tabular}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabular}{|p{3cm}|p{3cm}|p{3cm}|}
  \Hline
  Κωδικός\_Εκδήλωσης & Ύπαρξη\_Θέσεων\_VIP & Διάρκεια \\ \hline
  7777               & Όχι                 & 114      \\ \hline
  0666               & Ναι                 & 74       \\ \hline
\end{tabular}
\end{table}
